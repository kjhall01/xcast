...
class PCR:
    def __init__(self, eof_modes=None, latitude_weighting=False, separate_members=True, crossvalidation_splits=5, chunks=(5,5), **kwargs):
        ...
        self.model_type = MLR # this must be a class which has predict and predict_proba, and also probability of non-exceedance
    ...
    def predict(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        return preds.swap_dims({new_x_feature: x_feature_dim}).assign_coords({x_feature_dim: preds.coords[new_x_feature].values})
