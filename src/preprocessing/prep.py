...
class GammaTransformer:
    ...
    def _fit_source(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        self.dists = xr.apply_ufunc(_make_dist, X, input_core_dims=[[x_sample_dim]], output_core_dims=[[]], keep_attrs=True, vectorize=True)
    ...
    def transform(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        percentiles = xr.apply_ufunc(_apply_cdf, X, self.dists, input_core_dims=[[x_sample_dim], []], output_core_dims=[[x_sample_dim]], keep_attrs=True, vectorize=True)
        percentiles = percentiles.where(percentiles < 1, other=0.9999)
        percentiles = percentiles.where(percentiles > 0, other=0.0001)
...
class EmpiricalTransformer:
    ...
    def fit(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        self._make_edf_invcdfs(X, x_lat_dim, x_lon_dim, x_sample_dim,  x_feature_dim)
    ...
    def _make_cdfs(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        self.cdfs = xr.apply_ufunc(_make_invcdf, X, input_core_dims=[[x_sample_dim]], output_core_dims=[[]], keep_attrs=True, vectorize=True)
    ...
    def _make_edf_invcdfs(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        def _make_invcdf(x):
            ...
            cdf_vals_at_slope_changes = [empirical_cdf(i) for i in slope_changes]
            return interp1d(cdf_vals_at_slope_changes, slope_changes, fill_value='extrapolate')
        self.invcdfs = xr.apply_ufunc(_make_invcdf, X, input_core_dims=[[x_sample_dim]], output_core_dims=[[]], keep_attrs=True, vectorize=True)
    ...
    def transform(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        def _xr_invert1(x, cdf1):
            return cdf1(x)
        percentiles = xr.apply_ufunc(_xr_invert1, X, self.cdfs, input_core_dims=[[x_sample_dim], []], output_core_dims=[[x_sample_dim]], keep_attrs=True, vectorize=True)  # percentile(X )
        percentiles = percentiles.where(percentiles < 1, other=0.9999)
        percentiles = percentiles.where(percentiles > 0, other=0.0001)
        return invcdf(percentiles, x_lat_dim, x_lon_dim, x_sample_dim,  x_feature_dim, dist=self.destination_distribution)
    ...
    def inverse_transform(self, X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        x_lat_dim, x_lon_dim, x_sample_dim,  x_feature_dim = guess_coords(X, x_lat_dim, x_lon_dim, x_sample_dim,  x_feature_dim)
        check_all(X, x_lat_dim, x_lon_dim, x_sample_dim, x_feature_dim)
        percentiles = cdf(X, x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None, dist=self.destination_distribution)
        percentiles = percentiles.where(percentiles < 1, other=0.9999)
        percentiles = percentiles.where(percentiles > 0, other=0.0001)
