...
class RollingOneHotEncoder:
    def __init__(self, lead_low=7, lead_high=14, low=1.0/3.0, high=2.0/3.0, base_year=1999, n_years_to_search=30):
        self.low_thresh, self.high_thresh = low, high
        self.base_year = base_year
        self.lead_low = lead_low
        self.lead_high = lead_high
    ...
    def fit(self, X, quantile_method='midpoint', x_lat_dim=None, x_lon_dim=None, x_sample_dim=None, x_feature_dim=None):
        ...
        for doy in doys:
            ...
            coord.append(init)
            low = init + pd.Timedelta(days=self.lead_low)
            high = init + pd.Timedelta(days=self.lead_high)
...
class RollingMinMax:
    def __init__(self, lead_low=7, lead_high=14, base_year=1999, n_years_to_search=30):
        self.base_year = base_year
        self.lead_low = lead_low
        self.lead_high = lead_high
        self.n_years_to_search=n_years_to_search
