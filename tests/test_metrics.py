...
@pytest.mark.parametrize("mtr", xc.flat_classification_metrics)
...
@pytest.mark.parametrize("mtr", xc.flat_regression_metrics)
...
@pytest.mark.parametrize('mtr', xc.generalized_probabilistic_metrics)
...
@pytest.mark.parametrize('mtr', xc.categorical_probabilistic_metrics)
...
@pytest.mark.parametrize('mtr', xc.single_output_deterministic_metrics)
...
@pytest.mark.parametrize('mtr', xc.multiple_output_deterministic_metrics)
